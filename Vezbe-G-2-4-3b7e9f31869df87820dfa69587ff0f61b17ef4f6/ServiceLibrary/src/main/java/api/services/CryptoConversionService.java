...
public interface CryptoConversionService {
	...
	ResponseEntity<?> getCryptoConversionFeign(@RequestHeader("X-User-Email") String email, @RequestParam String from, @RequestParam String to, @RequestParam BigDecimal quantity);
